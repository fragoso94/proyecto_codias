...
class Impregnacion extends StatefulWidget{
  _Impregnacion createState() => _Impregnacion();
}

class _Impregnacion extends State<Impregnacion>{
  ...
  void onSubmitForm(){
    ...
    //conviertiendo de tipo text a double;
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10.0,),
                Text("El resultado es: $_total Lts.", style: TextStyle(fontSize: 20.0),),
                Text("El equivalente es: $_equivalente M3.", style: TextStyle(fontSize: 20.0),),
                Text("De Impregnación", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
              ],
            ),
          )
